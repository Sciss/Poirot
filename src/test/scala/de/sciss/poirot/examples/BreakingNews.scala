...
object BreakingNews extends App with Problem {
  ...
  val LocationName = Array("Bayonne", "NewHope", "PortCharles", "SouthAmboy")
  ...
  val reporter  = Vec.tabulate(4)(i => IntVar(ReporterName(i), 1, 4))
  val location  = Vec.tabulate(4)(i => IntVar(LocationName(i), 1, 4))
  val story     = Vec.tabulate(4)(i => IntVar(StoryName   (i), 1, 4))
